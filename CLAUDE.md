...
4. **Casks** — single batched `brew install --cask` for all GUI apps: VS Code, iTerm2, Claude (desktop), Claude Code (CLI), Microsoft Office, 1Password, Tailscale, Zotero, Inkscape, MacTeX, Blip, etc.
